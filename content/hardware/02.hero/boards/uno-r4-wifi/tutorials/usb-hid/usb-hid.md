...
This feature can create game controllers, keyboard extensions or other HID devices.
...
The following example moves both axes of the mouse just slightly (10 points), back and forth.
...
To see more examples, please refer to the links below:
